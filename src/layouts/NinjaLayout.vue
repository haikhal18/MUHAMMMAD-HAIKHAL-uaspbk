<template>
    <div class="ninja-layout">
      ...
      <NinjaSidebar :is-open="isSidebarOpen" />
  
      <main class="ninja-content">
  ...
  import NinjaSidebar from '@/components/ninja/NinjaSidebar.vue'; // Impor sidebar ninja
  ...
  <style scoped>
  /* Scoped styles untuk NinjaLayout */
  .ninja-layout {
  ...
  @media (max-width: 768px) {
    ...
    */
    ...
    .mobile-sidebar-overlay[data-v-a5b7d8c] { /* Gunakan selector dengan hash unik jika ingin lebih spesifik */
